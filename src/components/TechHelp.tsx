...
export default function TechHelp(props: Record<string, any>) {
	const { id } = props;
	...
	const title = "Техническая помощь";
	const text = "Окажем вам помощь при возникновении технических проблем";
